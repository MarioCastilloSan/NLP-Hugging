...
def getAnswer(question :str,conxtext:str )->str:
    qa = pipeline("question-answering", model=modelQ, tokenizer=tokenizer)
    pred = qa(question=question,context=conxtext)
    return pred['answer']

print(getAnswer(question,context))
